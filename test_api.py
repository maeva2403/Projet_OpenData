...
def fetch_data(category):
    ...
    while len(products) < 30:  # Continue jusqu'à obtenir 30 produits valides
...
def process_products(products):
    ...
    for product in products:
        ...
        for nutrient_key in selected_nutrients:
            ...
            product_data[nutrient_name] = nutrient_value #if nutrient_value is not None else "Non disponible"
...
for category in categories:
    st.write(f"Chargement des produits pour la catégorie : {category}...")
